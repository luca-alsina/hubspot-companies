    ...
    >
        ...
        <div class="px-6 py-4">
            ...
            <div class="row-auto flex justify-between">
                <div class="flex-col">
                    ...
                    <div class="flex flex-row justify-between mt-4">
                        <a href="mailto:{{ company.email }}" v-if="company.email" class="rounded-full bg-blue-500 hover:bg-blue-600 text-white w-12 h-12 flex items-center justify-center">
                        ...
                        <a href="tel:{{ company.phone }}" v-if="company.phone" class="rounded-full bg-green-500 hover:bg-green-600 text-white w-12 h-12 flex items-center justify-center">
            ...
            <div class="mt-4 text-sm text-gray-600">
                ...
                <div v-for="contact in company.contacts">
